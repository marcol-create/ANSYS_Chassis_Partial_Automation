...
| `acp_materials_rosettes.py` | Creates the Carbon Fiber and Honeycomb fabrics, the **Full Panel** stackup, and one rosette for every element set, automatically centered (still requires manual orienting). |
